...
#el código de Domochafis que intercepta los comandos siri
#fue extraido de siricontrol 
#link siricontrol>> https://github.com/theraspberryguy/SiriControl-System
...
class Control():
    def __init__(self, username, password):
        print('Domochafis 1.0.0 (home, Ene 28 2019 14:49:50')
        print('[compiled on Python 2.7.15]')
